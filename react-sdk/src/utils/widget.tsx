...
export const widgetCatalog: WidgetDefinition[] = [
  ...
  },
  {
    ...
    configs: [
      ...
      {
        key: "theme.card.header.background",
      ...
      {
        key: "theme.card.header.textColor",
      ...
      {
        key: "theme.card.description.textColor",
      ...
      {
        key: "theme.card.price.primaryTextColor",
      ...
      {
        key: "theme.card.price.secondaryTextColor",
      ...
      {
        key: "theme.card.price.background",
      ...
      {
        key: "theme.button.secondaryBackground",
      ...
      {
        key: "theme.button.secondaryTextColor",
      ...
      // Theme - Feature List
      {
        key: "theme.featureList.textColor",
