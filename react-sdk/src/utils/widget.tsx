...
export const widgetCatalog: WidgetDefinition[] = [
  ...
  },
  {
    ...
    configs: [
      ...
      {
        key: "theme.pricingTable.intervalToggle.background",
        label: "Toggle Background",
        type: "color",
        defaultValue: "#e5e7eb",
      ...
      {
        key: "theme.pricingTable.intervalToggle.activeBackground",
        label: "Active Toggle Background",
        type: "color",
        defaultValue: "#111827",
        section: "Theme: Toggle",
      ...
      {
        key: "theme.pricingTable.intervalToggle.activeText",
        label: "Active Toggle Text",
        type: "color",
        defaultValue: "#ffffff",
        section: "Theme: Toggle",
      ...
      {
        key: "theme.pricingTable.intervalToggle.inactiveText",
