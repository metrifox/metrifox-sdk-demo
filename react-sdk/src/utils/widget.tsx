...
export const widgetCatalog: WidgetDefinition[] = [
  {
    ...
    configs: [
      ...
      // Theme - Subscription
      {
        ...
        label: "Subscription Item Background",
        type: "color",
        defaultValue: "#ffffff",
      ...
      },
      {
        ...
        label: "Subscription Item Border Color",
        type: "color",
        defaultValue: "#e5e7eb",
        section: "Theme: Subscription",
      },
      ...
      // Plan: Card
      {
        key: "theme.customerPortal.plan.card.background",
        label: "Card Background",
        type: "color",
        defaultValue: "#ffffff",
        section: "Theme: Plan Card",
      },
      {
        key: "theme.customerPortal.plan.card.borderColor",
      ...
      {
        key: "theme.customerPortal.plan.card.descriptionColor",
      ...
      {
        key: "theme.customerPortal.plan.card.header.background",
      ...
      {
        key: "theme.customerPortal.plan.card.header.textColor",
      ...
      {
        key: "theme.customerPortal.plan.card.description.textColor",
      ...
      {
        key: "theme.customerPortal.plan.card.description.textButtonColor",
        label: "Description Button Color",
        type: "color",
        defaultValue: "#2563eb",
        section: "Theme: Plan Card",
      },
      {
        key: "theme.customerPortal.plan.card.price.amountColor",
      ...
      {
        key: "theme.customerPortal.plan.card.price.primaryTextColor",
      ...
      {
        key: "theme.customerPortal.plan.card.price.secondaryTextColor",
      ...
      {
        key: "theme.customerPortal.plan.card.price.background",
      ...
      {
        key: "theme.customerPortal.plan.card.price.borderColor",
        label: "Price Border Color",
        type: "color",
        defaultValue: "transparent",
        section: "Theme: Plan Card",
      },
      // Plan: Current Subscription Card
      {
        key: "theme.customerPortal.plan.currentSubscriptionCard.header.background",
        label: "Subscription Header Background",
        type: "color",
        defaultValue: "#f3f4f6",
        section: "Theme: Current Subscription",
      },
      {
        key: "theme.customerPortal.plan.currentSubscriptionCard.header.textColor",
        label: "Subscription Header Text",
        type: "color",
        defaultValue: "#111827",
        section: "Theme: Current Subscription",
      },
      {
        key: "theme.customerPortal.plan.currentSubscriptionCard.gradientColor",
        label: "Subscription Gradient",
        type: "color",
        defaultValue: "#e5e7eb",
        section: "Theme: Current Subscription",
      },
      // Plan: Features
      {
        key: "theme.customerPortal.plan.featureList.textColor",
        label: "Feature Text Color",
        type: "color",
        defaultValue: "#374151",
        section: "Theme: Plan Features",
      },
      {
        key: "theme.customerPortal.plan.featureList.iconColor",
      ...
      // Plan: Button
      {
        key: "theme.customerPortal.plan.button.background",
        label: "Button Background",
        type: "color",
        defaultValue: "#2563eb",
        section: "Theme: Plan Button",
      },
      {
        key: "theme.customerPortal.plan.button.textColor",
        label: "Button Text Color",
        type: "color",
        defaultValue: "#ffffff",
        section: "Theme: Plan Button",
      ...
      {
        key: "theme.customerPortal.plan.intervalToggle.background",
        label: "Toggle Background",
        type: "color",
        defaultValue: "#e5e7eb",
        section: "Theme: Plan Toggle",
      },
      {
        key: "theme.customerPortal.plan.intervalToggle.activeBackground",
      ...
      {
        key: "theme.customerPortal.plan.intervalToggle.activeText",
      ...
      // Plan: Free Trial Tag
      {
        key: "theme.customerPortal.plan.freeTrialTag.background",
        label: "Free Trial Background",
        type: "color",
        defaultValue: "#dbeafe",
        section: "Theme: Plan Tags",
      },
      {
        key: "theme.customerPortal.plan.freeTrialTag.textColor",
